...
public class ParkingInputDialog extends javax.swing.JDialog {
    ...
    public ParkingInputDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INPUT PARKING INFORMATION");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Sedan", "SUV", "Motorcycle", "Electric Vehicle", "Truck", "Others" }));
        jComboBox1.setPreferredSize(new java.awt.Dimension(113, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ParkingInputDialog dialog = new ParkingInputDialog(new javax.swing.JFrame(), true);
