...
if (lockOriginal != null) {
    ...
    private void initComponents() {
        ...
        loginUsername.setMargin(new java.awt.Insets(2, 110, 2, 6));
        loginUsername.setMinimumSize(new java.awt.Dimension(5, 20));
        loginUsername.setPreferredSize(new java.awt.Dimension(58, 20));
        loginUsername.setRequestFocusEnabled(false);
...
if (rememberMe.isSelected()) {
    ...
    prefs.put("savedUsername", loginUsername.getText());
